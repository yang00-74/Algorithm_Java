...
public class CalculateArea {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("面积是：" + c.calculatePolygonArea(list));
    ...
    // The method is using one point as the origin ,and then select closest two
    // point make up a
    // triangle,calculate each triangle and count them as the polygon`s area ;
    public int calculatePolygonArea(List<Point> list) {
